...
CREATE TYPE bxucoin_status AS ENUM ('valid', 'invalid');
...
CREATE TABLE bxucoin (
  bxucoin_id uuid NOT NULL,
  account_id uuid NOT NULL,
  status bxucoin_status NOT NULL DEFAULT 'valid',
  create_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  last_update timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (bxucoin_id)
);

CREATE TABLE bxucoin_hash_map (
  bxucoin_hash_id uuid NOT NULL,
  account_id uuid NOT NULL,
  amount numeric NOT NULL DEFAULT 0,
  create_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (bxucoin_hash_id)
);
